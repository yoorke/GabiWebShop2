<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HeaderMiddleContainer.ascx.cs" Inherits="VivoShop.customControls.Header.HeaderMiddleContainer" %>
...
<div class="site-header__middle container-fluid" style="height:110px">
            <div class="site-header__logo">
                <a href="/">
                    ...
                    <asp:Image runat="server" ImageUrl="~/images/logo.jpg" style="height:100px" />
                </a>
            </div>
            ...
            <%--<div class="site-header__phone">
                ...
                <div class="site-header__phone-number">023 581 810</div>
            </div>--%>
